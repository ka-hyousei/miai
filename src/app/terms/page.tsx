          ...
          <div className="prose prose-gray max-w-none space-y-8">
            ...
            <section>
              ...
              <ol className="list-decimal list-inside text-gray-600 space-y-2">
                ...
                <li className="text-red-600 font-medium">当サービスを通じて知り合った方との間で行われる金銭の貸借、投資、ビジネスへの勧誘等、金銭に関わる一切の行為について、当サービスは一切の責任を負いません。金銭トラブルに巻き込まれないよう、十分にご注意ください。</li>
              </ol>
            </section>

            <section className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-yellow-700 mb-4">【重要】金銭・投資に関するご注意</h2>
              <p className="text-gray-700 mb-4">
                当サービスはマッチングサービスであり、金銭の貸借や投資を目的としたサービスではありません。
              </p>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                <li>当サービスで知り合った方から金銭の貸借を持ちかけられた場合は、絶対に応じないでください。</li>
                <li>投資話や儲け話を持ちかけられた場合は、詐欺の可能性があります。</li>
                <li>ビジネスや副業への勧誘は禁止行為です。該当する行為を見つけた場合は通報してください。</li>
                <li>当サービスを通じて知り合った方との金銭トラブルについて、当サービスは一切関与いたしません。</li>
              </ul>
            </section>
