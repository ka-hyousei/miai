...
-- CreateEnum
CREATE TYPE "VisaType" AS ENUM ('PERMANENT_RESIDENT', 'WORK_VISA', 'SPOUSE_VISA', 'STUDENT_VISA', 'DEPENDENT_VISA', 'DESIGNATED_ACTIVITIES', 'OTHER', 'PRIVATE');

-- CreateEnum
CREATE TYPE "JapaneseLevel" AS ENUM ('NATIVE', 'N1', 'N2', 'N3', 'N4', 'N5', 'BEGINNER');

-- CreateEnum
CREATE TYPE "FuturePlan" AS ENUM ('STAY_LONG_TERM', 'RETURN_HOME', 'UNDECIDED', 'PRIVATE');

-- CreateEnum
CREATE TYPE "ReportReason" AS ENUM ('FAKE_PROFILE', 'HARASSMENT', 'INAPPROPRIATE', 'SPAM', 'SCAM', 'OTHER');
...
CREATE TABLE "Profile" (
    ...
    "occupation" TEXT,
    "visaType" "VisaType",
    "yearsInJapan" INTEGER,
    "japaneseLevel" "JapaneseLevel",
    "futurePlan" "FuturePlan",
    "nationality" TEXT,
    "hometown" TEXT,
    "isProfilePublic" BOOLEAN NOT NULL DEFAULT true,
    "showVisaType" BOOLEAN NOT NULL DEFAULT false,
    "showYearsInJapan" BOOLEAN NOT NULL DEFAULT false,
